...
import { aboutTeam, aboutTeamFounder } from '@/constants/about';
		...
		>
			<div className="mx-auto max-w-7xl">
				...
				<Reveal
					...
					className="mt-14"
				>
					<ul className="grid gap-4 sm:grid-cols-2 lg:flex lg:h-136 lg:gap-0 lg:overflow-hidden lg:rounded-xl lg:border lg:border-border">
						{aboutTeamFounder.map((member) => (
							<li
								key={member.name}
								className={cn(
									...
									'lg:focus-within:grow-[2.6] lg:hover:grow-[2.6]',
							...
							>
								...
								<span
									aria-hidden
									className="pointer-events-none absolute inset-x-0 bottom-0 h-2/3 bg-linear-to-t from-background via-background/70 to-transparent"
								/>
								...
								<div className="absolute inset-x-0 bottom-0 p-5">
									...
									<div
										className={cn(
											...
											'lg:group-hover/slat:grid-rows-[1fr] lg:group-hover/slat:opacity-100',
											'lg:group-focus-within/slat:grid-rows-[1fr] lg:group-focus-within/slat:opacity-100',
													...
													({ key, label }) => {
														...
														return (
															<Link
																...
																className="font-mono text-sm tracking-widest text-muted-foreground underline-offset-4 transition-colors hover:text-foreground hover:underline focus-visible:text-foreground"
															>
																{label}
															</Link>
														);
